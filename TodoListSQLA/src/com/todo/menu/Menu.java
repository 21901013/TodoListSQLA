...
public class Menu {
    ...
    public static void displaymenu()
    {
        ...
        System.out.println("13) Check the item by index ( comp )");
        System.out.println("14) Listing the checked items ( ls_comp )");
        System.out.println("15) Exiting this program (Or press escape key to exit)");
    }
